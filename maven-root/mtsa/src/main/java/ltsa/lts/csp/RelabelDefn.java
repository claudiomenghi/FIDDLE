...
public class RelabelDefn {
	...
	public void makeRelabels(Hashtable constants,
			Hashtable<String, Value> locals, Relation relabels) {
		mkRelabels(constants, locals, relabels);
	}

	private void mkRelabels(Hashtable constants,
			Hashtable<String, Value> locals, Relation relabels) {
		if (range != null) {
	...
	public static Relation getRelabels(Vector relabelDefns,
			Hashtable constants, Hashtable<String, Value> locals) {
	...
	public static Relation getRelabels(Vector relabelDefns) {
		return getRelabels(relabelDefns, new Hashtable(),
