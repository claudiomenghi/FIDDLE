...
public class LabelSet {
    ...
    protected static Hashtable<String,LabelSet> constants; // hashtable of constant sets, <string,LabelSet>

    protected LabelSet(Symbol s, Vector<ActionLabels> lbs) {
        labels = lbs;
    ...
    protected Vector<String> getActions(Hashtable locals, Hashtable params) {
