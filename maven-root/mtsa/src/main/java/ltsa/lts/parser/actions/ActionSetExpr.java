...
public class ActionSetExpr extends ActionLabels {
	...
	protected void initialise() {
		Vector<String> left_actions = left.getActions(locals, globals);
		Vector<String> right_actions = right.getActions(locals, globals);
		actions = new Vector<>();
		Enumeration<String> e = left_actions.elements();
