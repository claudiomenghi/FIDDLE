...
public class StateMachine {
	...
	public CompactState makeCompactState() {
		CompactState c = new CompactState(kludgeName);
	...
	public void addSequential(Integer state, CompactState mach) {
		if (sequentialInserts == null)
			sequentialInserts = new HashMap<>();
		sequentialInserts.put(state, mach);
	}

	public void preAddSequential(Integer start, Integer end, CompactState mach) {
	...
	public void setStateLabel(Counter stateLabel) {
