...
public class GeneralizedBuchiAutomata {
	...
	public GeneralizedBuchiAutomata(String name, FormulaFactory f, Vector alphaExt) {
		Preconditions.checkNotNull(name, "The name cannot be null");
		Preconditions.checkNotNull(f.getFormula(), "The formula contained in the formula factory cannot be null");
