...
import controller.game.model.SafeGameSolver;
...
import ac.ic.doc.mtstools.utils.GenericLTSToLongStringLTSConverter;
...
public class SafeGameSolverTests{
	...
	public Object[][] safeGameParameters() {
		return new Object[][] {
		{"../ltsa/dist/examples/SafetyCuts/Tests/safe_game_test.lts","MUT","EXP","C","G1","../ltsa/dist/examples/SafetyCuts/Results/safe_game_test.results"}
		};
	}	
